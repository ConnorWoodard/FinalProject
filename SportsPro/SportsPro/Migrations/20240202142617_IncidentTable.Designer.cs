...
namespace SportsPro.Migrations
{
    ...
    [Migration("20240202142617_IncidentTable")]
    partial class IncidentTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SportsPro.Models.Incidents", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            IncidentId = 2,
                            CustomerId = 2,
                            DateClosed = new DateTime(2024, 2, 2, 8, 26, 17, 267, DateTimeKind.Local).AddTicks(2351),
                            DateOpened = new DateTime(2021, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Received error code 123 when trying to install",
                            ProductId = 2,
                            TechnicianId = 2,
                        ...
                        new
                        {
                            IncidentId = 3,
                            CustomerId = 5,
                            DateClosed = new DateTime(2024, 2, 2, 8, 26, 17, 267, DateTimeKind.Local).AddTicks(2359),
