...
namespace SportsPro.Migrations
{
    ...
    [Migration("20240418151118_Initial")]
            ...
            modelBuilder.Entity("SportsPro.Models.DomainModels.Incidents", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            IncidentId = 2,
                            CustomerId = 2,
                            DateClosed = new DateTime(2024, 4, 18, 10, 11, 17, 842, DateTimeKind.Local).AddTicks(7024),
                            DateOpened = new DateTime(2021, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Received error code 123 when trying to install",
                            ProductId = 2,
                            TechnicianId = 2,
                        ...
                        new
                        {
                            IncidentId = 3,
                            CustomerId = 5,
                            DateClosed = new DateTime(2024, 4, 18, 10, 11, 17, 842, DateTimeKind.Local).AddTicks(7032),
