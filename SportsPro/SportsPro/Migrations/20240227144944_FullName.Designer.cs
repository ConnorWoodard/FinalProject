...
namespace SportsPro.Migrations
{
    ...
    [Migration("20240227144944_FullName")]
            ...
            modelBuilder.Entity("SportsPro.Models.Incidents", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            IncidentId = 2,
                            CustomerId = 2,
                            DateClosed = new DateTime(2024, 2, 27, 8, 49, 43, 666, DateTimeKind.Local).AddTicks(4533),
                            DateOpened = new DateTime(2021, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Received error code 123 when trying to install",
                            ProductId = 2,
                            TechnicianId = 2,
                        ...
                        new
                        {
                            IncidentId = 3,
                            CustomerId = 5,
                            DateClosed = new DateTime(2024, 2, 27, 8, 49, 43, 666, DateTimeKind.Local).AddTicks(4540),
