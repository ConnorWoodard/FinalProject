...
namespace SportsPro.Migrations
{
    ...
    [Migration("20240426141617_Publish")]
            ...
            modelBuilder.Entity("SportsPro.Models.DomainModels.Incidents", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            IncidentId = 2,
                            CustomerId = 2,
                            DateClosed = new DateTime(2024, 4, 26, 9, 16, 17, 95, DateTimeKind.Local).AddTicks(4864),
                            DateOpened = new DateTime(2021, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Received error code 123 when trying to install",
                            ProductId = 2,
                            TechnicianId = 2,
                        ...
                        new
                        {
                            IncidentId = 3,
                            CustomerId = 5,
                            DateClosed = new DateTime(2024, 4, 26, 9, 16, 17, 95, DateTimeKind.Local).AddTicks(4872),
